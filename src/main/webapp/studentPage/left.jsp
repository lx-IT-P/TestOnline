...
<body>
	    ...
	    <li class="level1">
            ...
            <ul class="MenuLevel2">
            	<li class="level2 level2Style">
                    <a target="right" href="${pageContext.request.contextPath }/">查看考试安排</a>
				</li>

				<li class="level2 level2Style">
					<a  href="${pageContext.request.contextPath }/QuestionServlet?method=selectQuestion" target="right" >参加考试</a>
				</li>

                <li class="level2 level2Style">
                	<a  href="${pageContext.request.contextPath }/" target="right" >考试管理规定</a>
				</li>
	...
	<ul class="Menu">
		<li class="level1">
			...
			<ul class="MenuLevel2">
				<li class="level2 level2Style">
					<a target="right" href="${pageContext.request.contextPath }/ExamServlet?method=selectScore">查看成绩</a>
				</li>

				<li class="level2 level2Style">
					<a  href="${pageContext.request.contextPath }/" target="right" >错题统计</a>
				</li>
	...
	<ul class="Menu">
		<li class="level1">
			...
			<ul class="MenuLevel2">
				<li class="level2 level2Style">
					<a target="right" href="${pageContext.request.contextPath }/">查看信息</a>
				</li>
				<li class="level2 level2Style">
					<a target="right" href="${pageContext.request.contextPath }/">修改信息</a>
				</li>
